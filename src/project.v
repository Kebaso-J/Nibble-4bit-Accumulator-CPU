...
// Nibble 4-bit CPU
//=======================================================================
// Top-level module for TinyTapeout Sky130nm
//
// Pin Mapping:
...
module tt_um_jacob_kebaso_4bit_cpu (
    input wire     clk,
    input wire     rst_n,
    input wire     ena,
    ...
    //Output mapping
    assign uo_out[3:0] = acc_out; // Output the accumulator value on the lower 4 bits of uo_out
    assign uo_out[4]   = carry_out; // Output the carry flag on bit 4 of uo_out
    assign uo_out[5]   = zero_out;  // Output the zero flag on bit 5 of uo_out
    assign uo_out[6]   = halted_out; // Output the halted flag on bit 6 of uo_out
    assign uo_out[7]   = phase_out;  // Output the phase on bit 7 of uo_out

    //Bidirectional: lower 4 = output (PC), upper 4 = input (port)
    assign uio_out[3:0] = pc_out; // Output the program counter
    assign uio_out[7:4] = 4'b0000;
    assign uio_oe       = 8'b00001111; // Enable output for lower 4 bits (PC), upper 4 bits are input
